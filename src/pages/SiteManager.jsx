...
const emptyForm = {
  name: "", owner: "delkal_energy", contact_name: "", contact_phone: "", contact_email: "", dc_capacity_kwp: "", ac_capacity_kw: "",
        ...
        {showForm && (
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
              ...
              <Field label="שם בעל האתר" field="contact_name" placeholder="ישראל ישראלי" />
              <Field label="טלפון בעל האתר" field="contact_phone" type="tel" placeholder="+972501234567" />
              <Field label="מייל בעל האתר" field="contact_email" type="email" placeholder="owner@example.com" />
              <div className="space-y-1">
